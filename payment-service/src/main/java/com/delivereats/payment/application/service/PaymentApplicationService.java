...
import com.delivereats.payment.domain.event.PaymentCompletedEvent;
...
public class PaymentApplicationService implements ProcessPaymentUseCase, RefundPaymentUseCase, GetPaymentStatusUseCase {
	...
	public PaymentResponse processPayment(PaymentRequest request) {
		...
		paymentPublisher.publish("payment.completed",
				new PaymentCompletedEvent(request.orderId(), payment.getId(), payment.getAmount(),
